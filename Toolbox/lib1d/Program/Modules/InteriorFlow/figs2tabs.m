function varargout = figs2tabs(figHandles,tabname)
...
for tabNum=1:length(figHandles)
   ...
   add_tab(tabbedFig, tabGroupH, figHandle, tabNum,tabname{tabNum});
end
...
function add_tab(tabbedFig, tabGroupH, figHandle, tabNum,tabname)
...
uiMenuIndxsBool = cregexp(types,'colorbar');
% 
...
tgroup = uitabgroup('Parent', thisTabH);
set(validChildren,'Parent', tgroup );    
end
