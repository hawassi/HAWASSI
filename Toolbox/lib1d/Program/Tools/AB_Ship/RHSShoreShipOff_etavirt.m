...
%%%%%%%%%%%%%%%%%  RHS for RunUp  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function dz = RHSShoreShipOff_etavirt(time,z,model,par,influx,IVP,Oprt,shippar,ProgStatbar)
%%%%%passing parameter%%%%%%%%%%%%%%
...
%                 shippar.rad.Fpsi,shippar.rad.FpsiEv,dxi_Krad]=fun_radiation_potential_anzats_Interp(g,k,par.x.',OprtS,shippar.tangenflowGlobal,shippar.form.shapeXcZc(end,:).',shippar.form.dxshapeXcZc(end,:).',Smotion,2,nutild,xShip,shippar.form.XZrot0,chiSWl(:,end),1,0,'Flat');
% 
%                 
% %             [shippar.rad.psi,shippar.rad.Ma,shippar.rad.dampC,shippar.rad.LpsiEv,...
...
dteta_hat   = (dteta_hat + Swall_hat + Source - fft(par.dampcoef.*dampchar.*Upeta)).*aal;
dtphi_hat   = (dtphi_hat + Rb_hat +Rf_hat+Rw_hat -  fft(par.dampcoef.*dampchar.*Upu)./(1i.*k)).*aal;
