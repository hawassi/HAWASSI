function [phif,tau,Fs,Fev,Lev,beta,dxi_K,etaWl,dxetaWl,tauAz]=funS_tangential_potential3_Ndom(calclin,k,x,xShip,Sdraft,Slength,sZ,phi,eta,chiship,chiwaterline,depth,Evmodes,XZrot0,lambda_p,kappaS,taug,L0,F0,Nonlin,ChiAdj,shipformOnGrid,shapedat)
Nship=1;
