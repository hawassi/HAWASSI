...
function [Amat,Bvect] =fun_construct_matrices_diffraction_Ndom0(Ndom,psibdy,dxpsibdy,tauGbdy,dxtauGbdy,Dbdy,dxDbdy,DZetabdy,dxDZetabdy,dr,Evmodes,kappaS,etaWl,dxetaWl,phiWl,dxphiWl,Xbdy)
Ns=1;
...
%     pause;
    ...
    for ii=1:(NvarI-1)/2
       ...
       Bvect(Nm*Ns*n+1)=-IQ0Vpn1L;
       Bvect(Nm*Ns*n+Nm/2+1)=-(kappaS(1,1)*IQ0Qn1L+IdxQ0Qn1L);
